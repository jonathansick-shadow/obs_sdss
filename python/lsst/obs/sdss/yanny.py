# Licensed under a 3-clause BSD style license - see yanny-LICENSE.rst
# -*- coding: utf-8 -*-
...
LSST NOTE:
This file was copied from the version in pydl 0.4.1:

https://github.com/weaverba137/pydl/blob/0.4.1/pydl/pydlutils/yanny/yanny.py
